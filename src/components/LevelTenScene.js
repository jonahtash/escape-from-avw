...
import Door1 from '../img/hallway_to_hell_pt2.png';
import Door2 from '../img/hallway_final_door.png';
...
class LevelTenScene extends React.Component {
	constructor(props) {
		super(props);
		this.state = {
			hint: false,
